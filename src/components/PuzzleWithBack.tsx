/* pefekt funktioniert nur für ein standort import { useState, useRef, useEffect } from "react";
...
const CONGRATS_DURATION_MS = 7000; // ⏱ 7 Sekunden
        ...
        {showCongrats && (
          <group position={[0, 0.1, 0.6]}>
            ...
            <Text
              ...
              color="#1f3f2e"
            >
              Sie haben das Puzzle in {formatTime(currentTime)} bewältigt!
            </Text>
